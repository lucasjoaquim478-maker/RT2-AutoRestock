...
btnRow.BackgroundTransparent = true
btnRow.Parent = frame
...
statsLabel.BackgroundTransparent = true
...
listFrame.BackgroundTransparent = true
listFrame.ClipsDescendants = true
listFrame.Parent = frame

local list = Instance.new("ScrollingFrame")
list.Size = UDim2.new(1, 0, 1, 0)
list.BackgroundTransparent = true
...
empty.BackgroundTransparent = true
...
local function refreshList(filter)
  ...
  for name, prod in products do
    ...
    stock.BackgroundTransparent = true
    ...
    minL.BackgroundTransparent = true
    minL.Text = "Min:"
